      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-8">
        ...
        >
          <h2 className="text-4xl lg:text-5xl font-bold text-white mb-4">
            Ready to <span className="text-cyan-300">Automate</span>?
          </h2>
          <p className="text-xl text-gray-400 max-w-2xl mx-auto">
            Get a free demo and see how AI can transform your business operations.
          </p>
        </motion.div>
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-gray-400 leading-relaxed">
                  Let's discuss how YEL6AI can help you capture more leads, automate follow-ups, and increase revenue without adding headcount.
                </p>
              </div>
            ...
            <form onSubmit={handleSubmit} className="p-8 rounded-2xl bg-black/40 border border-cyan-500/30">
              <div className="space-y-6">
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="w-full px-8 py-4 bg-cyan-600 text-white rounded-lg font-semibold flex items-center justify-center gap-2 hover:bg-cyan-500 transition-all"
                >
